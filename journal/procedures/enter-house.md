...
4. **Z-alignment:** if z > 572.3, face north and `walk_until z ≤ 572.1`. The corridor past the door is flanked by chests at z=571/573. Pathfinder consistently lands at z≈572.5 which can clip these obstacles.
