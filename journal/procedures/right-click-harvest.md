...
3. **2026-05-30 — robust deposit + seed management.** Two fixes after the hopper deposit was
   ...
   - **Surplus seeds auto-deposit.** After the wheat step, if `wheat_seeds > 7` the bot
     stashes all seeds into the kitchen chest, keeping 0 (see [[deposit-seeds]]). Seeds are
