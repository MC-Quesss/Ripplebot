...
Mineflayer-based Minecraft bot for a modded 1.12.2 Forge server. Connects via Microsoft auth, exposes a TCP control API on `127.0.0.1:25580`, and runs autonomous behaviors (auto-sleep, auto-greet).
